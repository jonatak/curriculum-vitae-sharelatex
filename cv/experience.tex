...
%---------------------------------------------------------
  \cventry
    ...
    {PredictHQ - Startup} % Organization
    {Auckland, New Zealand} % Location
    {January 2017 – Now} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Developed python micro services to improve event enrichments and data quality of our event pipeline based on kafka.}
        \item {Developed a ranking services based on our data analyst research.}
        \item {Developed and migrate an entity pipeline based on kafka style micro services.}
        \item {Developed various REST API using bottle/flask to access our Elasticsearch database.}
        \item {Investigate and integrate various data providers to our event solution.}
        \item {Wrote and maintains Helm and Kubernetes deployment files.}
      \end{cvitems}
    }
